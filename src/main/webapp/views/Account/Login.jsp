            ...
            <div class='shadow-lg rounded-lg p-8 bg-white flex flex-col'>
                ...
                <div class='mt-5'>
                    <div class='flex justify-between'>
                        ...
                        <a href="${pageContext.request.contextPath}/Account/Forget_Password"
                           class='text-indigo-600 hover:underline block'>Quên mật khẩu</a>
                    </div>
                    <input id="password" name="password" type="password" autocomplete="current-password" required
                           class='mt-2 w-full px-2 py-1 outline-none block border-2 rounded-md  border-gray-300'>
                </div>
                <c:if test="${hasError}">
                    <div class='alert__login text-red-500 mt-3'>Mật khẩu hoặc tài khoản không đúng</div>
                </c:if>
                <div class='mt-8'>
                    <button type="submit"
                ...
                <div class='mt-3'>
                    Chưa có tài khoản? <a href="${pageContext.request.contextPath}/Account/Register"
                                          class='text-indigo-600 hover:underline'>Đăng kí ngay!</a>
                </div>
            </div>
        </form>
    </div>
