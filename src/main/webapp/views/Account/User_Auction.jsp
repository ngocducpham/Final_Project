    ...
    <jsp:body>
        <c:choose>
            <c:when test="${User_Auction_Product_List.size()==0}">
                ...
                <div class='max-w-4xl h-screen mx-auto flex flex-col w-50 '>
                    ...
                    <h6 style="font-size: 40px" class='text-danger font-weight-bold mt-12 align-left'>Bạn Chưa Tham Gia Đấu Giá !</h6>
                    <div class="btn-sm align-items-center">
