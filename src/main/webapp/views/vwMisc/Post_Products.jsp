                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control background" name="Pname" id="pname"
                                   placeholder="Laptop Gaming" value="">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="price">Giá khởi điểm</label>
                            <input type="number" class="form-control background" name="Price" id="price"
                                   value="" placeholder="16.000.000 VND">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="step_price">Bước Giá</label>
                            <input type="number" class="form-control background" name="Step-Price" id="step_price"
