...
<div style='background-image: url("${pageContext.request.contextPath}/public/imgs/footer-bg.jpg");'
     class='w-full bg-center bg-cover mt-2 relative pb-8'>
    <div class='bg-white'>
        <svg id="wave" style="transform:rotate(180deg); transition: 0.3s" viewBox="0 0 1440 140" version="1.1"
            ...
            <path style="transform:translate(0, 0px); opacity:1" fill="url(#sw-gradient-0)"
                  d="M0,84L34.3,81.7C68.6,79,137,75,206,67.7C274.3,61,343,51,411,51.3C480,51,549,61,617,53.7C685.7,47,754,23,823,28C891.4,33,960,65,1029,86.3C1097.1,107,1166,117,1234,107.3C1302.9,98,1371,70,1440,60.7C1508.6,51,1577,61,1646,74.7C1714.3,89,1783,107,1851,112C1920,117,1989,107,2057,91C2125.7,75,2194,51,2263,53.7C2331.4,56,2400,84,2469,84C2537.1,84,2606,56,2674,39.7C2742.9,23,2811,19,2880,28C2948.6,37,3017,61,3086,67.7C3154.3,75,3223,65,3291,58.3C3360,51,3429,47,3497,58.3C3565.7,70,3634,98,3703,100.3C3771.4,103,3840,79,3909,63C3977.1,47,4046,37,4114,39.7C4182.9,42,4251,56,4320,67.7C4388.6,79,4457,89,4526,84C4594.3,79,4663,61,4731,53.7C4800,47,4869,51,4903,53.7L4937.1,56L4937.1,140L4902.9,140C4868.6,140,4800,140,4731,140C4662.9,140,4594,140,4526,140C4457.1,140,4389,140,4320,140C4251.4,140,4183,140,4114,140C4045.7,140,3977,140,3909,140C3840,140,3771,140,3703,140C3634.3,140,3566,140,3497,140C3428.6,140,3360,140,3291,140C3222.9,140,3154,140,3086,140C3017.1,140,2949,140,2880,140C2811.4,140,2743,140,2674,140C2605.7,140,2537,140,2469,140C2400,140,2331,140,2263,140C2194.3,140,2126,140,2057,140C1988.6,140,1920,140,1851,140C1782.9,140,1714,140,1646,140C1577.1,140,1509,140,1440,140C1371.4,140,1303,140,1234,140C1165.7,140,1097,140,1029,140C960,140,891,140,823,140C754.3,140,686,140,617,140C548.6,140,480,140,411,140C342.9,140,274,140,206,140C137.1,140,69,140,34,140L0,140Z">
            </path>
        </svg>
    </div>
    <!-- Footer item -->
    <div class='max-w-6xl mx-auto h-fit'>
        <div class='flex justify-between'>
            <div class='max-w-md'>
                <svg class='fill-white w-52' viewBox="0 0 143 32" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <div class='mt-10 flex flex-col space-y-5'>
                    <div class='flex text-white font-medium'>
                        <svg class='h-9 w-9 stroke-white' xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class='flex text-white font-medium'>
                        <svg class='h-7 w-7 stroke-white' xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em"
                             height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                            <g fill="none">
                                <path
            ...
            <div class='flex space-x-20'>
                ...
                <div>
                    <div class='text-white text-xl font-medium'>Follow Us</div>
                    <div class='h-1 w-12 bg-white mt-1'></div>
                    <div class='mt-10 flex space-x-3 text-white text-lg'>
                        <svg class='fill-white h-8 w-8 hover:fill-cyan-500' xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em"
                             height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                            <g>
                        ...
                        <svg class='fill-white h-8 w-8 hover:fill-cyan-500' xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em"
                             height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 1000 1000">
                            <path
                        ...
                        <svg class='fill-white h-8 w-8 hover:fill-cyan-500' xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="0.88em"
