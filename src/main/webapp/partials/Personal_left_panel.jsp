...
<div class="navUser">
    ...
    <div class="navigateBox">
        ...
        <div class="myProfile"><a href="${pageContext.request.contextPath}/Personal/Post_Products" class="a__myProfile"><i class="blue fas fa-stream pr-2"></i>Đăng bán Sản Phẩm</a></div>
