...
INSERT INTO `categories` VALUES (1,'Laptop',8,2),(2,'Điện thoại',8,2),(3,'Quần áo',9,2),(4,'Giày Dép',9,2),(5,'Dụng cụ thể thao',10,2),(6,'Thực phẩm hỗ trợ',10,2),(7,'Thiết bị đeo',NULL,1),(8,'Đồ điện tử',NULL,1),(9,'Thời trang',NULL,1),(10,'Sức khỏe',NULL,1);
...
-- Dump completed on 2021-12-21 22:25:26
